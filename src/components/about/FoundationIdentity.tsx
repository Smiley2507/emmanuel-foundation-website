        ...
        <section className="py-48 bg-[#FAFAF8]">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="text-center mb-12">
                    <h2 className="h2 text-[var(--color-primary-vibrant)]">
                        Driven by compassion. Rooted in community. Focused on lasting impact.
                    </h2>
                </div>
                {/* Mission */}
                <div className="mb-12">
                    <h3 className="h3 text-[var(--color-primary-vibrant)] mb-4">Mission</h3>
                ...
                {/* Vision */}
                <div className="mb-12">
                    <h3 className="h3 text-[var(--color-primary-vibrant)] mb-4">Vision</h3>
                    <p className="text-xl text-foreground/80 leading-relaxed">
                ...
                {/* Core Values */}
                <div>
                    <h3 className="h3 text-[var(--color-primary-vibrant)] mb-6">Core Values</h3>
                    <ul className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <li className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
                            <h4 className="h4 text-[var(--color-primary-vibrant)] mb-2">Integrity &amp; Accountability</h4>
                        ...
                        <li className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
                            <h4 className="h4 text-[var(--color-primary-vibrant)] mb-2">Human Dignity</h4>
                        ...
                        <li className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
                            <h4 className="h4 text-[var(--color-primary-vibrant)] mb-2">Social Responsibility</h4>
                        ...
                        <li className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
                            <h4 className="h4 text-[var(--color-primary-vibrant)] mb-2">Partnership &amp; Collaboration</h4>
                        ...
                        <li className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
                            <h4 className="h4 text-[var(--color-primary-vibrant)] mb-2">Equity &amp; Inclusion</h4>
